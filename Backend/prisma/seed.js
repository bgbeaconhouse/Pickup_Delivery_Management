...
const seed = async () => {
    ...
    const createPickups = async () => {
        const pickups = [
            {name: "Johnny", phoneNumber: "(714) 478-2897", items: "black couch", images: ["https://mobileimages.lowes.com/productimages/474d2d16-2ae4-4a18-8ad7-ca6a469f8cb4/69461759.jpeg?size=xl"], notes: "Has attached ottoman", pickupDate: new Date (2025, 3, 19)},
            {name: "Tammy", phoneNumber: "(714) 245-6787", items: "brown couch", images: ["https://m.media-amazon.com/images/I/71IRzkMUakL._AC_UF894,1000_QL80_.jpg"], notes: "Leather", pickupDate: new Date (2025, 3, 18)}
        ]
